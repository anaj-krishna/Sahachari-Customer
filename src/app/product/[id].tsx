...
export default function ProductDetails() {
  ...
  return (
    <View className="flex-1 bg-white">
        ...
        <View className="p-5">
          ...
          <View className="flex-row items-center mt-2">
            ...
            {finalPrice < originalPrice && (
              <Text className="ml-3 text-gray-400 line-through text-lg">
                ₹{originalPrice}
              </Text>
            )}
          </View>
          <Text className="mt-6 text-gray-600 leading-6 text-base">
            {product.description}
          </Text>
        </View>
      </ScrollView>
      ...
      {/* Footer Actions */}
      <View
        className="flex-row p-4 border-t border-gray-100"
